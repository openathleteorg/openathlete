        ...
        render={({ field, fieldState: { error } }) => {
          ...
          useEffect(() => {
            ...
            if (field.value === undefined || field.value === null) {
              ...
              if (unit === 'min_per_km') {
                const pace = msToPace(field.value);
                setPaceMinutes(pace.minutes.toString());
                setPaceSeconds(pace.seconds.toString());
              } else if (unit === 'km_per_h') {
                setValueInput(msToKmh(field.value).toString());
              } else {
                setValueInput(field.value.toString());
              }
              setLastSyncedValue(field.value);
            }
          ...
          const handleUnitChange = (newUnit: VelocityUnit) => {
            ...
            if (field.value === undefined || field.value === null) {
              ...
              currentValueMs = isNaN(currentInput) ? field.value : currentInput;
            }
          ...
          return (
            <div className="flex items-center w-full">
              ...
              <Select value={unit} onValueChange={handleUnitChange}>
                ...
                <SelectContent>
                  <SelectItem value="m_per_s">
                    {m.meters_per_second()}
                  </SelectItem>
                  <SelectItem value="km_per_h">
