...
export function ClubsWorkflow() {
  const steps = [
    {
      title: m.clubs_workflow_step_1(),
      Icon: Sparkles,
    },
    {
      title: m.clubs_workflow_step_2(),
      Icon: Zap,
    },
    {
      title: m.clubs_workflow_step_3(),
      Icon: CheckCircle2,
    },
    {
      title: m.clubs_workflow_step_4(),
      Icon: BarChart3,
    },
  ];
