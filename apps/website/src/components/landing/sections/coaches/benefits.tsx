...
export function CoachesBenefits() {
  const items = [
    { label: m.coaches_benefits_item_1(), Icon: Clock3 },
    { label: m.coaches_benefits_item_2(), Icon: ShieldCheck },
    { label: m.coaches_benefits_item_3(), Icon: Users },
    { label: m.coaches_benefits_item_4(), Icon: TrendingUp },
  ];
