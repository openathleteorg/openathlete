...
// Suunto supports day scheduling; popup suggestion is device-side.
// Degrade complex targets to notes/open when needed.
...
export const mapToSuunto: ProviderMapper = (
  date: string,
